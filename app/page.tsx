...
const tools = [
...

  {
    ...
    description:
      "Converta imagens entre formatos como PNG, JPG e WebP de forma simples.",
    icon: "🖼️",
    link: "#",
  },

  {
    title: "PDF para Word",
    description:
      "Transforme seus arquivos PDF em documentos editáveis com facilidade.",
    icon: "📝",
    link: "#",
  },
      ...
      <section className="relative overflow-hidden border-b border-blue-100 bg-gradient-to-b from-blue-50 via-white to-slate-50">
        ...
        <div className="relative mx-auto max-w-5xl px-5 py-24 text-center sm:py-28">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base leading-7 text-slate-500 sm:text-lg">
            Comprima, converta, junte e organize seus arquivos
            de forma rápida e fácil. Tudo em um só lugar.
          </p>
        ...
        <div className="mb-10 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
          ...
          <div>
            ...
            <p className="mt-3 max-w-xl text-sm leading-6 text-slate-500">
              Escolha uma ferramenta e resolva sua tarefa de forma rápida,
        ...
        <div className="mx-auto max-w-7xl px-5 py-20">
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-sm leading-6 text-slate-500">
              Ferramentas pensadas para tornar suas tarefas do dia a dia
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-7 text-center transition duration-300 hover:-translate-y-1 hover:border-blue-200 hover:bg-blue-50/50">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-500">
                Faça o que precisa sem passar por processos complicados.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-7 text-center transition duration-300 hover:-translate-y-1 hover:border-blue-200 hover:bg-blue-50/50">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-500">
                Encontre ferramentas práticas para arquivos, documentos e imagens.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-slate-50 p-7 text-center transition duration-300 hover:-translate-y-1 hover:border-blue-200 hover:bg-blue-50/50">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-500">
                Uma interface clara para você encontrar exatamente o que precisa.
              </p>
            </div>
      ...
      <section className="bg-blue-600">
        <div className="mx-auto max-w-4xl px-5 py-16 text-center sm:py-20">
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm leading-6 text-blue-100 sm:text-base">
            Escolha uma ferramenta e torne seu trabalho mais simples.
          </p>
